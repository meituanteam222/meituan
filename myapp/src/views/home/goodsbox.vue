<template>
	<div class="goodsbox" >
		...
		<div>
			<div  @click="goDetail(goodsObj.gid)"><span style="position: relative;left: 18px;color: #000000;">{{goodsObj.title}}</span></div>
			...
			<div style="position: relative;display:block ;left: 235px;top: 55px;">
